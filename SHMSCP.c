...
void edit()
{
    ...
    if(q<=5)
    {
        printf("Enter the id no. of patient= (0 - %d)=",num-1);
...
{
    int f,h;
    printf("Enter the id number of the patient that you want to delete");
    scanf("%d",&f);
    if(f<num)
    {
        printf("Select\n");
...
void read()
{
    ...
    if(fp == NULL)
    {
        ...
        fclose(fp);
        printf("File does not exist, JUST CREATED IT, exiting...\n\n\n");
        return 0;
    }
